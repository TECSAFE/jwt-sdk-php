...
class JwtCustomer implements JSONModelInterface
{
        ...
        /** @var JwtCustomer_Meta67d48a617277a The meta object contains additional information about the token, or the token's owner */
        protected $meta;
...
if (!is_string($value)) {
  ...
  1 => 'string',
             ...
             *
             * @return JwtCustomer_Meta67d48a617277a
             */
            public function getMeta()
                : JwtCustomer_Meta67d48a617277a
            {
    ...
    try {
        return is_array($value) ? new JwtCustomer_Meta67d48a617277a($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof JwtCustomer_Meta67d48a617277a)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'meta',
  1 => 'JwtCustomer_Meta67d48a617277a',
)));
}
