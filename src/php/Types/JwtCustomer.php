...
class JwtCustomer implements JSONModelInterface
{
        ...
        /** @var JwtCustomer_Meta66d83bb039cfa The meta object contains additional information about the token, or the token's owner */
        protected $meta;
...
if (!is_string($value)) {
  ...
  1 => 'string',
             ...
             *
             * @return JwtCustomer_Meta66d83bb039cfa
             */
            public function getMeta()
                : JwtCustomer_Meta66d83bb039cfa
            {
    ...
    try {
        return is_array($value) ? new JwtCustomer_Meta66d83bb039cfa($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof JwtCustomer_Meta66d83bb039cfa)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'meta',
  1 => 'JwtCustomer_Meta66d83bb039cfa',
)));
}
