...
class JwtCustomer implements JSONModelInterface
{
        ...
        /** @var JwtCustomer_Meta66a7e8bee66a3 The meta object contains additional information about the token, or the token's owner */
        protected $meta;
...
if (!is_string($value)) {
  ...
  1 => 'string',
             ...
             *
             * @return JwtCustomer_Meta66a7e8bee66a3
             */
            public function getMeta()
                : JwtCustomer_Meta66a7e8bee66a3
            {
    ...
    try {
        return is_array($value) ? new JwtCustomer_Meta66a7e8bee66a3($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof JwtCustomer_Meta66a7e8bee66a3)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'meta',
  1 => 'JwtCustomer_Meta66a7e8bee66a3',
)));
}
