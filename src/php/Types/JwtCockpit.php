...
class JwtCockpit implements JSONModelInterface
{
        ...
        /** @var JwtCockpit_Meta67c82d7249c81 The meta object contains additional information about the token, or the token's owner */
        protected $meta;
...
if (!is_string($value)) {
  ...
  1 => 'string',
             ...
             *
             * @return JwtCockpit_Meta67c82d7249c81
             */
            public function getMeta()
                : JwtCockpit_Meta67c82d7249c81
            {
    ...
    try {
        return is_array($value) ? new JwtCockpit_Meta67c82d7249c81($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof JwtCockpit_Meta67c82d7249c81)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'meta',
  1 => 'JwtCockpit_Meta67c82d7249c81',
)));
}
