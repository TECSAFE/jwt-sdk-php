...
class JwtSalesChannel implements JSONModelInterface
{
        ...
        /** @var JwtSalesChannel_Meta67c82d7b4643c The meta object contains additional information about the token, or the token's owner */
        protected $meta;
...
if (!is_string($value)) {
  ...
  1 => 'string',
             ...
             *
             * @return JwtSalesChannel_Meta67c82d7b4643c
             */
            public function getMeta()
                : JwtSalesChannel_Meta67c82d7b4643c
            {
    ...
    try {
        return is_array($value) ? new JwtSalesChannel_Meta67c82d7b4643c($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof JwtSalesChannel_Meta67c82d7b4643c)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'meta',
  1 => 'JwtSalesChannel_Meta67c82d7b4643c',
)));
}
