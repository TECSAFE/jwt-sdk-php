...
class JwtSalesChannel implements JSONModelInterface
{
        ...
        /** @var JwtSalesChannel_Meta674d000d4acc1 The meta object contains additional information about the token, or the token's owner */
        protected $meta;
...
if (!is_string($value)) {
  ...
  1 => 'string',
             ...
             *
             * @return JwtSalesChannel_Meta674d000d4acc1
             */
            public function getMeta()
                : JwtSalesChannel_Meta674d000d4acc1
            {
    ...
    try {
        return is_array($value) ? new JwtSalesChannel_Meta674d000d4acc1($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof JwtSalesChannel_Meta674d000d4acc1)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'meta',
  1 => 'JwtSalesChannel_Meta674d000d4acc1',
)));
}
