...
class JwtInternal implements JSONModelInterface
{
        ...
        /** @var JwtInternal_Meta674d000d4a79b The meta object contains additional information about the token, or the token's owner */
        protected $meta;
...
if (!is_string($value)) {
  ...
  1 => 'string',
             ...
             *
             * @return JwtInternal_Meta674d000d4a79b
             */
            public function getMeta()
                : JwtInternal_Meta674d000d4a79b
            {
    ...
    try {
        return is_array($value) ? new JwtInternal_Meta674d000d4a79b($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof JwtInternal_Meta674d000d4a79b)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'meta',
  1 => 'JwtInternal_Meta674d000d4a79b',
)));
}
