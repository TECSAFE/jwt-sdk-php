...
class JwtInternal implements JSONModelInterface
{
        ...
        /** @var JwtInternal_Meta6683d6ca18368 The meta object contains additional information about the token, or the token's owner */
        protected $meta;
...
if (!is_string($value)) {
  ...
  1 => 'string',
             ...
             *
             * @return JwtInternal_Meta6683d6ca18368
             */
            public function getMeta()
                : JwtInternal_Meta6683d6ca18368
            {
    ...
    try {
        return is_array($value) ? new JwtInternal_Meta6683d6ca18368($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof JwtInternal_Meta6683d6ca18368)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'meta',
  1 => 'JwtInternal_Meta6683d6ca18368',
)));
}
