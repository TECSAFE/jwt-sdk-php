...
class JwtInternal implements JSONModelInterface
{
        ...
        /** @var JwtInternal_Meta66d9965d2b0be The meta object contains additional information about the token, or the token's owner */
        protected $meta;
...
if (!is_string($value)) {
  ...
  1 => 'string',
             ...
             *
             * @return JwtInternal_Meta66d9965d2b0be
             */
            public function getMeta()
                : JwtInternal_Meta66d9965d2b0be
            {
    ...
    try {
        return is_array($value) ? new JwtInternal_Meta66d9965d2b0be($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof JwtInternal_Meta66d9965d2b0be)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'meta',
  1 => 'JwtInternal_Meta66d9965d2b0be',
)));
}
