...
class JwtBase implements JSONModelInterface
{
        ...
        /** @var JwtBase_Meta66da90d0421eb The meta object contains additional information about the token, or the token's owner */
        protected $meta;
...
if (!is_string($value)) {
  ...
  1 => 'string',
             ...
             *
             * @return JwtBase_Meta66da90d0421eb
             */
            public function getMeta()
                : JwtBase_Meta66da90d0421eb
            {
    ...
    try {
        return is_array($value) ? new JwtBase_Meta66da90d0421eb($value) : $value;
...
if (is_object($value) && !($value instanceof \Exception) && !($value instanceof JwtBase_Meta66da90d0421eb)) {
    $this->_errorRegistry->addError(new \PHPModelGenerator\Exception\Object\InvalidInstanceOfException($value ?? null, ...array (
  0 => 'meta',
  1 => 'JwtBase_Meta66da90d0421eb',
)));
}
